...
# 侧边栏导航
# ======================
st.sidebar.title("广西职业师范学院应用")
page = st.sidebar.radio(
    "选择功能",
    ["学校介绍", "个人简历生成器", "动物图鉴", "南宁美食数据", "数字档案"]
)
...
if page == "学校介绍":
    ...
    st.subheader("校园风光")
    st.image("https://ts1.tc.mm.bing.net/th/id/R-C.71e70587ae5419531bf534fa66c39c51?rik=uizuOiYAArH1DA&riu=http%3a%2f%2fstatic-data.gaokao.cn%2fupload%2fsvideo%2f1611730557_9407_thumb.jpg&ehk=YlKROXwF1PlkdAC34aFiKYtJ%2fi0vOM%2fbCxpr5%2fxqfjI%3d&risl=&pid=ImgRaw&r=0", caption="广西职业师范学院主校区", use_column_width=True)
