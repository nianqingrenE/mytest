...
price_data = pd.DataFrame({
    "月份": months * 5,  # 长度60：12×5
    "店铺名称": [
        "复记老友粉"]*12 + ["舒记老友粉"]*12 + 
        ["爱民螺蛳粉"]*12 + ["桂小厨"]*12 + ["粉之都"]*12,  # 长度60
    "人均价格(元)": [
        # 复记老友粉（12个月）
...
st.map(
    shops, 
    latitude="纬度",  # 显式指定纬度列名
    longitude="经度", # 显式指定经度列名
...
st.image(
    "https://img1.baidu.com/it/u=3444030644,3544334060&fm=253&fmt=auto&app=138&f=JPEG?w=500&h=375",
    caption="复记老友粉",
    use_container_width=True
)
